...
////////////////////////////////////////////////////////// ?>
	...
	<div role="contentinfo" class="contentinfo">
		<div class="copy copy--contain delta-heading space-trailer-m">
			<p>
				Photography is my passion, while <a href="https://artlantis.nl" rel="me" class="link link--simple link--no-history"><abbr title="user experience">ux</abbr> design</a> is my trade.
				If you want learn more about me, my rates or availablity, or just want to go out for a <a href="https://en.wikipedia.org/wiki/Photowalking" rel="external">photowalk</a>, please don't hesitate to <a href="<?php echo $site->find('contact')->url(); ?>" class="link link--simple link--no-history">contact me</a>.
			</p>
		</div>
