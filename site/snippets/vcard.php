...
<div vocab="http://schema.org/" typeof="Person" class="h-card vcard">
	...
	<span property="address" typeof="PostalAddress" class="h-adr adr">
			<?php if($page->street()->isNotEmpty()): ?><span property="streetAddress" class="p-street-address street-address is-hidden-visually"><?php echo $page->street()->smartypants(); ?></span><?php endif; ?>
