...
// Ignore (sub)pages and/or single pages
$ignore_pages_incl_subpages = array('home', 'commisioned', 'about', 'blog', 'series', 'base', 'sitemap', 'search', 'error', 'drafts');
$ignore_pages_excl_subpages = array();
...
<?php if(in_array($page->slug(), $ignore_pages_incl_subpages) || in_array($page->parent()->uri(), $ignore_pages_incl_subpages) || in_array($page->slug(), $ignore_pages_excl_subpages)) continue ?>
